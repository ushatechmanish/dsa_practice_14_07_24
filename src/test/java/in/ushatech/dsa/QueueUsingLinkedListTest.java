...
import in.ushatech.dsa.queue.QueueUsingLinkedList;
...
public class QueueUsingLinkedListTest {
    ...
    @BeforeEach
    public void setUp() {
        queue = new QueueUsingLinkedList(); // Initialize queue with capacity of 5
    }
    ...
    @Test
    public void testIsNeverFull() {
        for (int i = 1; i <= 5; i++) {
            queue.enQueue(i);
        }
        assertFalse(queue.isFull(), "Queue should never be full ");
    }
