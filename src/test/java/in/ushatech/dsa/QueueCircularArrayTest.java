...
import in.ushatech.dsa.queue.QueueUsingCircularArray;

public class QueueCircularArrayTest {
    private QueueUsingCircularArray queue;

    @BeforeEach
    public void setUp() {
        queue = new QueueUsingCircularArray(5); // Initialize queue with capacity of 5
    }
